...
@section('content')
    <script src="{{LotteryVccPath::getAssets('js/turntable.min.js')}}"></script>
    ...
    <script>
        ...
        $.turntable(obj_div,data_came,{'wheel':"{{LotteryVccPath::getAssets('img/game_wheel.png')}}",'pin':"{{LotteryVccPath::getAssets('img/game_pin.png')}}"},{'width':parseInt(obj_div.css('width')),'height':parseInt(obj_div.css('height'))},slicePrizes,callback);
    </script>
@endsection